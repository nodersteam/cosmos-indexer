...
var file_blocks_proto_rawDesc = []byte{
	...
	0x65, 0x42, 0x79, 0x48, 0x6f, 0x75, 0x72, 0x52, 0x06, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x73, 0x32,
	0xce, 0x0c, 0x0a, 0x0d, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x73, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
...
var file_blocks_proto_msgTypes = make([]protoimpl.MessageInfo, 53)
...
var file_blocks_proto_depIdxs = []int32{
	53, // 0: blocks.Block.generation_time:type_name -> google.protobuf.Timestamp
	0,  // 1: blocks.GetBlockInfoResponse.info:type_name -> blocks.Block
	53, // 2: blocks.TxByDay.day:type_name -> google.protobuf.Timestamp
	53, // 3: blocks.TxChartByDayRequest.from:type_name -> google.protobuf.Timestamp
	53, // 4: blocks.TxChartByDayRequest.to:type_name -> google.protobuf.Timestamp
	...
	53, // 18: blocks.TotalTransactionsRequest.to:type_name -> google.protobuf.Timestamp
	...
	53, // 22: blocks.TotalBlocksRequest.to:type_name -> google.protobuf.Timestamp
	...
	53, // 29: blocks.SignerAddress.time:type_name -> google.protobuf.Timestamp
	...
	53, // 39: blocks.ChartTransactionsByHourRequest.to:type_name -> google.protobuf.Timestamp
	53, // 40: blocks.TxsByHour.hour:type_name -> google.protobuf.Timestamp
	48, // 41: blocks.ChartTransactionsByHourResponse.points:type_name -> blocks.TxsByHour
	53, // 42: blocks.ChartTransactionsVolumeRequest.to:type_name -> google.protobuf.Timestamp
	53, // 43: blocks.TxsVolumeByHour.hour:type_name -> google.protobuf.Timestamp
	...
	2,  // 64: blocks.BlocksService.BlockInfo:output_type -> blocks.GetBlockInfoResponse
	46, // 65: blocks.BlocksService.BlockInfoByHash:output_type -> blocks.BlockInfoByHashResponse
	4,  // 66: blocks.BlocksService.BlockValidators:output_type -> blocks.GetBlockValidatorsResponse
	7,  // 67: blocks.BlocksService.TxChartByDay:output_type -> blocks.TxChartByDayResponse
	9,  // 68: blocks.BlocksService.TxByHash:output_type -> blocks.TxByHashResponse
	21, // 69: blocks.BlocksService.TotalTransactions:output_type -> blocks.TotalTransactionsResponse
	25, // 70: blocks.BlocksService.Transactions:output_type -> blocks.TransactionsResponse
	27, // 71: blocks.BlocksService.TotalBlocks:output_type -> blocks.TotalBlocksResponse
	29, // 72: blocks.BlocksService.GetBlocks:output_type -> blocks.GetBlocksResponse
	31, // 73: blocks.BlocksService.BlockSignatures:output_type -> blocks.BlockSignaturesResponse
	34, // 74: blocks.BlocksService.TxsByBlock:output_type -> blocks.TxsByBlockResponse
	36, // 75: blocks.BlocksService.TransactionRawLog:output_type -> blocks.TransactionRawLogResponse
	38, // 76: blocks.BlocksService.TransactionSigners:output_type -> blocks.TransactionSignersResponse
	25, // 77: blocks.BlocksService.CacheTransactions:output_type -> blocks.TransactionsResponse
	29, // 78: blocks.BlocksService.CacheGetBlocks:output_type -> blocks.GetBlocksResponse
	40, // 79: blocks.BlocksService.CacheAggregated:output_type -> blocks.CacheAggregatedResponse
	44, // 80: blocks.BlocksService.SearchHashByText:output_type -> blocks.SearchHashByTextResponse
	49, // 81: blocks.BlocksService.ChartTransactionsByHour:output_type -> blocks.ChartTransactionsByHourResponse
	52, // 82: blocks.BlocksService.ChartTransactionsVolume:output_type -> blocks.ChartTransactionsVolumeResponse
